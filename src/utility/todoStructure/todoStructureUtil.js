export function toDoStructure(title,description,dueDate,priority){
    ...
    delIcon.setAttribute('src','/home/anirudh/OdinProject/repos/FS-JS/Intermediate-JS/todos/src/icons/delete.svg');
    toDoIconsContainer.appendChild(delIcon);

    const editIcon = document.createElement('img');
    editIcon.classList.add('icon','edit-icon');
    editIcon.setAttribute('src','/home/anirudh/OdinProject/repos/FS-JS/Intermediate-JS/todos/src/icons/edit.svg');
    toDoIconsContainer.appendChild(editIcon);

    const openIcon = document.createElement('img');
    openIcon.classList.add('icon','open-icon');
    openIcon.setAttribute('src','/home/anirudh/OdinProject/repos/FS-JS/Intermediate-JS/todos/src/icons/open.svg');
